...
class Voplus extends StatelessWidget {
  ...
  Voplus({required this.j , required this.imaginaryZL , required this.realZL ,
      ...
      body: Container(
        child: Padding(
          ...
          child: SingleChildScrollView(
            child:  Column(
              children: [
                Text("Result:  ${voplus1.re.toStringAsFixed(3)} + ${voplus1.im.toStringAsFixed(3)}j \n   "  , style: TextStyle(color: Colors.black , fontSize: 25, ) ),
                ExpansionTile(
                    ...
                    children: [
                      ...
                      ListTile( title: Math.tex("V(-${r'\ell'}) = ${VZ1.re.toStringAsFixed(3)} + ${VZ1.im.toStringAsFixed(3)}j",  textStyle: TextStyle(fontSize: 25 , color: Colors.black , ),)),
